...
[![npm version](https://img.shields.io/npm/v/fip-cli)](https://www.npmjs.com/package/fip-cli)
...
**依赖**: [Node.js](https://nodejs.org) ≥ v16, [Kimi WebBridge](https://kimi-webbridge.moonshot.cn) 浏览器扩展 + 守护进程, Chrome（开启 `--remote-debugging-port=9222`）
