...
const tables = [
  {
    ...
    columns: [
      ...
      { header: '城市维护建设税', field: 'urban_maintenance_tax', type: 'amount' },
      { header: '教育费及附加', field: 'education_surcharge', type: 'amount' },
      { header: '地方教育费及附加', field: 'local_education_surcharge', type: 'amount' },
  ...
  },
  {
    ...
    columns: [
      ...
      { header: '发票金额（含税）', field: 'invoice_amount_with_tax', type: 'amount' },
      { header: '前期累计扣减分包发票金额', field: 'accumulated_deduction', type: 'amount' },
      { header: '在途金额', field: 'in_transit_amount', type: 'amount' },
      { header: '本次可扣减发票金额', field: 'available_deduction', type: 'amount' },
