...
export const tables: Array<{
  ...
  },
  {
    ...
    columns: [
      ...
      { header: '预算组织机构', field: 'budget_organization' },
      { header: '预算部门', field: 'budget_department' },
